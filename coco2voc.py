...
CKimg_dir = '/home/ev/Net/Datasets/tt100k_2021/tt100k_voc/images'  # voc图片路径
CKanno_dir = '/home/ev/Net/Datasets/tt100k_2021/tt100k_voc/annotations'  # voc注释路径
...
def main():
    base_dir = '/home/ev/Net/Datasets/tt100k_2021/tt100k_voc'  # step1 这里是一个新的文件夹，存放转换后的图片和标注
    image_dir = os.path.join(base_dir, 'images')  # 在上述文件夹中生成images，annotations两个子文件夹
    anno_dir = os.path.join(base_dir, 'annotations')
    mkr(image_dir)
    mkr(anno_dir)
    origin_image_dir = '/home/ev/Net/Datasets/tt100k_2021/images'  # step 2原始的coco的图像存放位置
    origin_anno_dir = '/home/ev/Net/Datasets/tt100k_2021/dataset/annotations'  # step 3 原始的coco的标注存放位置
