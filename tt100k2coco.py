...
# 存放数据的父路径
parent_path = '/home/ev/Net/Datasets/tt100k_2021'
...
# 保存结果
for phase in ['train2017', 'val2017', 'test2017']:
    json_name = os.path.join(parent_path, 'annotations/{}.json'.format(phase))  # origin = dataset/annotations
    with open(json_name, 'w', encoding="utf-8") as f:
        if phase == 'train':
